...
class LeaveBalanceTests {
    ...
    void create_RespectsRemainingBalance(int usedDays, int requestedDays, boolean accepted) {
        ...
        LeaveRequestsController controller = new LeaveRequestsController(new LeaveRequestService(employees, requests), mock(com.example.leavemanagement.service.LeaveApprovalService.class));
    ...
    void create_RejectsMissingFieldsBeforeRepositoryAccess() {
        EmployeeRepository employees = mock(EmployeeRepository.class);
        LeaveRequestRepository requests = mock(LeaveRequestRepository.class);
        var controller = new LeaveRequestsController(new LeaveRequestService(employees, requests), mock(com.example.leavemanagement.service.LeaveApprovalService.class));
    ...
    void create_UnknownEmployeeReturns404WithoutSaving() {
        ...
        assertEquals(404, new LeaveRequestsController(new LeaveRequestService(employees, requests), mock(com.example.leavemanagement.service.LeaveApprovalService.class))
    ...
    private void check(List<LeaveRequest> history, LeaveType type, String start, String end,
        ...
        var response = new LeaveRequestsController(new LeaveRequestService(employees, requests), mock(com.example.leavemanagement.service.LeaveApprovalService.class)).create(dto);
